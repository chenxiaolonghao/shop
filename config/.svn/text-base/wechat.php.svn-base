...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx6b235d0ef54f8644'),         // AppID
    'secret'  => env('WECHAT_SECRET', '51863d483ee27828a765b7a068b56ac6'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'mly'),          // Token
     ...
     */
       'oauth' => [
           ...
           'callback' => env('WECHAT_OAUTH_CALLBACK', 'http://chenxiaolong.top/mlyweixin/1/member_center.html'),///examples/oauth_callback.php
       ],
